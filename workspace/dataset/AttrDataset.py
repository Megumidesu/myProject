...
class MultiModalAttrDataset(data.Dataset):
    ...
    def __init__(self, split, args, transform=None, target_transform=None):
        ...
        assert args.dataset in ['AIRPLANE', 'DUKE'], \
            f'dataset name {args.dataset} is not exist,The legal name is AIRPLANE'
        if args.dataset =='AIRPLANE' :
            data_path='/root/autodl-tmp/workspace/dataset/AIRPLANE/ppc_dataset.pkl'
